...
nop_test    .macro      ;\1 = opcode, \2 = # of bytes
        ...
        .endif
            ...
            set_a $ff-\1,0
            .byte  \1       ;test nop integrity - flags off
            nop
            nop
            tst_a $ff-\1,0
            set_a $aa-\1,$ff
            .byte  \1       ;test nop integrity - flags on
            nop
            nop
            tst_a $aa-\1,$ff
            cpy #$42
...
ram_chksm   .word  0            ;checksum for RAM integrity test
pg_x    .word  0                ;high JMP indirect address for page cross bug
